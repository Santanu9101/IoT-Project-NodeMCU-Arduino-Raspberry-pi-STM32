// Task 1.Create Car structure globally consisting of Model, colour and price and print on the screen.
...
// // Task 2 Write a program to create structure globally enter the name,age and salary of employees and manager.
// If the manager age is above 30 then the salary will be 65000 otherwise 55000.
...
// // Task 3 Create a structure named Book to store book details like title, author, and price. Write a C program to input details for
// three books, find the most expensive and the lowest priced books, and display their information.
...
// // Task 4 Define a structure named Circle to represent a circle with a radius. Write a C program to create user defined
// function to calculate the area and perimeter of two circles and display the results in the main function.
